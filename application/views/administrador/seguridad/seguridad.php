      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3><sup style="font-size: 20px">REGISTRAR</sup></h3>
              
              <h3><sup style="font-size: 20px">NUEVO USUARIO</sup></h3>
            ...
            <a href="<?php echo base_url('seguridad/registrar')?>" class="small-box-footer">Entrar <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              ...
              <h3><sup style="font-size: 20px">USUARIOS</sup></h3>
            ...
            <a href="<?php echo base_url('seguridad/ver_usuarios')?>" class="small-box-footer">Entrar <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
