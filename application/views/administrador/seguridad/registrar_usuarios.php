    ...
    <section class="content">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title"><b>REGISTRAR USUARIOS</b></h3>
        ...
        <!-- /.box-header -->
        <div class="box-body">
          <form method="POST" action="<?php echo base_url();?>seguridad/registrar_usuarios" >
              <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <input type="text" class="form-control" required name="contrasena">
                      </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <div class="input-group">
                        ...
                        <select class="form-control" id="estado" required name="tipo_usuario">
          ...
          <div class="box-footer">
           <center><button type="submit"  value="" class="btn btn-info"><i class="fa fa-save"></i> Registrar </button>
               <a href="<?php echo base_url('seguridad/seguridad')?>" class="btn btn-default"><i class="fa fa-close"></i> Cancelar </a></button>
           </center>
          </div>
        </form>
      </div>
