          ...
          <div class="col-xs-12">
             <div class="box box-info">
                  <div class="box-header with-border">
                     <h3 class="box-title"><b>REGISTRO DE USUSARIOS</b></h3>
                        ...
                        <?php foreach($usuarios as $usuarios): ?>
                            <tr>
                              ...
                              <td>
                                ...
                                <a href="<?php echo base_url('mantenimiento/editar_tipo_material/'. $usuarios->ID_USUARIOS) ?>"><button type="button" class="btn btn-primary">Editar</button></a>
                                <a href="<?php echo base_url('mantenimiento/eliminar/' . $usuarios->ID_USUARIOS) ?>"><button type="button" class="btn btn-danger">Eliminar</button></a>
                              </td>
                            </tr>
                            <?php endforeach; ?>
