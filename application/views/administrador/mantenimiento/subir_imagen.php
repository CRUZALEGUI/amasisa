    ...
    <section class="content">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title"><b>SUBIR IMAGEN AL SERVIDOR</b></h3>
        ...
        <!-- /.box-header -->
        <div class="box-body">
          <form method="POST" action="<?php echo base_url();?>mantenimiento/cargar_imagen" enctype="multipart/form-data" >
              <div class="row">
          ...
          <div class="box-footer">
           <center><button type="submit"  value="" class="btn btn-info"><i class="fa fa-save"></i> Registrar </button>
               <a href="<?php echo base_url('mantenimiento')?>" class="btn btn-default"><i class="fa fa-close"></i> Cancelar </a></button>
           </center>
          </div>
        </form>
      </div>
