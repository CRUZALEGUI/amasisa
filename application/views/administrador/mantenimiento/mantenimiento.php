      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3><sup style="font-size: 20px">SUBIR IMAGENES  </sup></h3>
                        
              <h3><sup style="font-size: 20px">AL SERVIDOR</sup></h3>
            ...
            <a href="<?php echo base_url('mantenimiento/subir_imagen')?>" class="small-box-footer">Entrar <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
