	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-t-50 p-b-90">
				<form action="<?php echo base_url();?>registro/guardar" method="POST" class="login100-form validate-form flex-sb flex-w">
					<span class="login100-form-title p-b-51">
						REGISTRO
					</span>

					<div class="wrap-input100 validate-input m-b-16" data-validate = "Llenar este campo">
					...
					<div class="container-login100-form-btn m-t-17">
						<a href="<?php echo base_url('inicio_cliente')?>"><button class="login100-form-btn">
							Atrás
						</button></a>
					</div>
			</div>
